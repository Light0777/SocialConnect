...
import { Image, TouchableOpacity, View, Text, TextInput, ScrollView, StatusBar, Animated, Platform, Alert, KeyboardAvoidingView, } from "react-native";
...
export default function HomeScreen() {
  ...
  const saveProfile = async () => {
    ...
    try {
      await handleUpdateProfile(profileData, setProfile);

      // ✅ Save the exact updated profile locally
          ...
          <View style={{ alignItems: "center", marginBottom: 30 }}>
            <View style={{ position: 'relative' }}>
              <Image
                source={{
                  uri:
                    profileImg && profileImg.trim().length > 0
                      ? profileImg
